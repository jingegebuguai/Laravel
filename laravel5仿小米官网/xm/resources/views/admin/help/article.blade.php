...
<div class="mws-panel grid_8 mws-collapsible">
    <div class="mws-panel-header">
        <span> <i class="icon-table"></i>
            帮助栏目文章列表
            <a href="/admin/help/add" class="btn btn-danger pull-right" >添加帮助栏目文章</a>
        </span>
    </div>
    <div class="mws-panel-inner-wrap">
        <div class="mws-panel-body no-padding">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
            <form action="/admin/help/article" method="get">
                ...
                <table class="mws-table mws-datatable dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                    <thead>
                        <tr role="row">
                            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 80px;">栏目文章ID</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 220px;">标题</th>
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 71px;">显示状态</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 123px;">添加日期</th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                       @foreach($articles as $k=>$v)
                        <tr class="">
                            ...
                            <td>{{$v->title}}</td>
                            <td>{{$v->helpCate->name}}</td>
                            <td><input class="ibutton" cid="{{$v->id}} " type="checkbox" @if($v->status) checked @endif></td>
                            <td>{{$v->created_at}}</td>
                            <td>
                                <span class="btn-group">
                                    <a href="/admin/help/artedit?id={{$v->id}}" class="btn btn-small" title="编辑栏目分类">
                                        <i class="icon-pencil"></i>
                                    </a>
                                    <a href="/admin/help/artdel?id={{$v->id}}" class="btn btn-small" title="删除栏目分类">
